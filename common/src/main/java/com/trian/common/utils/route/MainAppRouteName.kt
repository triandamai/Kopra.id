...
object  Routes{
    ...
    const val SHEET_FORM_ORDER = "SHEET_FORM_ORDER"
    const val SHEET_DETAIL_HOSPITAL ="SHEET_DETAIL_HOSPITAL"
    ...
    object SmartwatchRoute{
        ...
        const val BOTTOMSHEET_HEALTH_MONITORING = "BOTTOMSHEET_HEALTHMONITORING"
        const val BOTTOMSHEET_DISTANCE ="BOTTOMSHEET_DISTANCE"
        const val BOTTOMSHEET_TEMPERATURE = "BOTTOMSHEET_TEMPERATURE"
        const val BOTTOMSHEET_BLOOD_PRESSURE_CALIBRATION = "BOTTOMSHEET_BLOODPRESURECALIBRATION"
    }
}